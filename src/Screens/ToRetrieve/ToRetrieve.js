...
export default function ToRerieve({ navigation, AppStates }) {
  /********************************
  * Props
  *******************************/
  const {
...
const orderfilterByStoreTest = test["hydra:member"] && test["hydra:member"]?.filter((order) => order.status === "overtime"
